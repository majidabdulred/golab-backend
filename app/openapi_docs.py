...
class GetMeResponse(BaseModel):
    ...
    model_config = {"json_schema_extra": {"examples": get_me_demo_response_examples}}


response_get_me = {
    200: {"description": "This is description", "model": GetMeResponse},
    401: CODE_401,
}
...
class CreateSessionResponse(BaseModel):
    ...
    model_config = {
        "json_schema_extra": {
            "examples": [{"success": True, "instance_id": "i-0fb45fb3b178dead7"}]
        }
    }


response_create_session = {
    200: {"description": "This is description", "model": CreateSessionResponse},
    401: CODE_401,
    403: {
        "content": {
            "application/json:": {
...
response_ping = {
    ...
    403: {
        "content": {
            "application/json:": {
                "example": {"detail": "User does not have access to this instance"}
            }
        }
    },
    400: {
        "content": {
            "application/json:": {"example": {"detail": "Instance not running"}}
        }
    },
}
...
response_reset_send_otp = {
    200: {
        "content": {
            "application/json": {"example": {"otp_id": "64e467b68028c88b0ee6bdd0"}}
        }
    },
...
response_reset_verify_otp = {
    200: {
        "content": {
            "application/json": {
                "example": {"verified": True, "otp_id": "64e467b68028c88b0ee6bdd0"}
            }
        }
    },
