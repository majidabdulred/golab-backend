...
@auth.post("/reset/new_password")#, responses=openapi_docs.response_reset_new_password)
...
@app.post("/txt2img/generate")#, responses=openapi_docs.create_txt2img_demo_response_examples)
